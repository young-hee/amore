...
this["AP"]["handlebars"]["display"]["events"]["event-over"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<li>\n	<img alt=\"\" src=\""
    ...
    + "</dd>\n	</dl>\n	<span class=\"d_day\">"
    + ((stack1 = (helpers.xif || (depth0 && depth0.xif) || alias2).call(alias1,(depth0 != null ? depth0.closedRestDays : depth0),"!=",0,{"name":"xif","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "</span>\n</li>\n";
