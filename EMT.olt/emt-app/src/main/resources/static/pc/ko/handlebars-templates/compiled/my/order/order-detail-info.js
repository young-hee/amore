...
this["AP"]["handlebars"]["my"]["order"]["order-detail-info"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "		<dl>\n			<dt>주문상태</dt>\n			<dd><em>"
    + container.escapeExpression((helpers.ordMgmtStatusCheck || (depth0 && depth0.ordMgmtStatusCheck) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),"store",((stack1 = (depth0 != null ? depth0.ordInfo : depth0)) != null ? stack1.ordDetailStatusCode : stack1),{"name":"ordMgmtStatusCheck","hash":{},"data":data}))
  ...
  return "					<dd><em>"
    + container.escapeExpression((helpers.ordMgmtStatusCheck || (depth0 && depth0.ordMgmtStatusCheck) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = (depth0 != null ? depth0.ordInfo : depth0)) != null ? stack1.ordStatusCode : stack1),{"name":"ordMgmtStatusCheck","hash":{},"data":data}))
    + "</em></dd>\n";
  ...
  return "					<dd><em>"
    ...
    + " "
    + alias2((helpers.ordStatusCheck || (depth0 && depth0.ordStatusCheck) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),"returnExchange",((stack1 = (depth0 != null ? depth0.ordInfo : depth0)) != null ? stack1.claimProgressStatusCode : stack1),{"name":"ordStatusCheck","hash":{},"data":data}))
    + " "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.ordInfo : depth0)) != null ? stack1.claimProgressStatusCode : stack1), depth0))
    + "</em></dd>\n";
