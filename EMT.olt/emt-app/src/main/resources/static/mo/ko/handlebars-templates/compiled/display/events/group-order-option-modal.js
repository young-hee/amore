...
this["AP"]["handlebars"]["display"]["events"]["group-order-option-modal"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
  ...
  return "								<strong>"
    + container.escapeExpression((helpers.numberFormat || (depth0 && depth0.numberFormat) || alias2).call(alias1,((stack1 = (depth0 != null ? depth0.prodPriceSummaryStp : depth0)) != null ? stack1.onlineSalePriceStp : stack1),{"name":"numberFormat","hash":{},"data":data}))
    + "</strong>\n								<span>\n"
  ...
  return "\n<div class=\"evt_goods\">\n	<fieldset class=\"form\">\n		<legend class=\"sr_only\">상품옵션</legend>\n		<div class=\"scroll_area\">\n\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.productsStp : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "		</div>\n		\n		<div class=\"form_btns\">\n			<button class=\"btn_md_secondary\" type=\"button\">취소</button>\n			<button class=\"btn_md_neutral\" type=\"button\">선택 상품 담기</button>\n		</div>\n		\n	</fieldset>\n</div>\n			\n";
