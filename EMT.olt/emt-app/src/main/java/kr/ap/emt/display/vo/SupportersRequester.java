...
public class SupportersRequester {
	 ...
	 /**
	    ...
	    private List<UploadingFile> files = new ArrayList<UploadingFile>();  
	    /**
		 * ��û�����ڵ�
		 */
		...
		public List<UploadingFile> getFiles() {
			return files;
		}

		public void setFiles(List<UploadingFile> files) {
			this.files = files;
		}
